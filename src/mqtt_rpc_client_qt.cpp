...
#define MQTT_AUTOGEN_CERT "-----BEGIN CERTIFICATE-----\n"\
"MIIDDzCCAfegAwIBAgIUOKCEW75QRqq2jqkEAg9S4xRQ4YQwDQYJKoZIhvcNAQEL\n"\
"BQAwFjEUMBIGA1UEAwwLdmVudXMubG9jYWwwIBcNMjQwNjE0MTQwOTAzWhgPMjEy\n"\
"NDA2MTQxNDA5MDNaMBYxFDASBgNVBAMMC3ZlbnVzLmxvY2FsMIIBIjANBgkqhkiG\n"\
"9w0BAQEFAAOCAQ8AMIIBCgKCAQEAocTU20oVq2JDCCU5DjuSAFWNezHO7B+/iyRJ\n"\
"6Q+xGi6qisQv6eoL2AYGEM0lxGBR4wJcu4A+pmb9KqYrkDyFIKB0NVtbNs25VqXo\n"\
"t32TECpPp+5ROMuriZJ/7hlSROhB83ZHQtmj2Cq1D7nbml2o+gfq6RLznoctqzFZ\n"\
"+EeZe5mkzY1IhEM8u8/Xni/+1eJHuS7YYYtDSY+P24BTMi5t2wsG08VgUR4GoPsG\n"\
"T1QVB1og2VMKXuL6RFb7c7iCCnXjbEzletjJRHHbqf210MyU+mm2E4WNEFOSYGqs\n"\
"xS2Cpeiv4l/kU0aQ4HbhPG65B0XIMixGyFPxy5yXt3cjGNvcKwIDAQABo1MwUTAd\n"\
"BgNVHQ4EFgQUXQV3cd0cthHabSc5IMw3RQQhLU4wHwYDVR0jBBgwFoAUXQV3cd0c\n"\
"thHabSc5IMw3RQQhLU4wDwYDVR0TAQH/BAUwAwEB/zANBgkqhkiG9w0BAQsFAAOC\n"\
"AQEAVb0UYMTLRr0KQM0qeGzGFOIUs9k5ZnbtjY5dXOzD79T/Asx5FeRcqgWoCOhn\n"\
"rFwfWx0xeg8vLfuKFtpOm0DhtV1yw1bW+9X5W1HUJtq/WZaFc0ilMoPmyB2mPGr/\n"\
"E7RwFlREkn7kLlQYEuTc5lgCB0/o2NLd9VUne1qfMUs7iiFb03FEatJUGxfcHMyu\n"\
"jWGPnSRVp41F5E5dqE3t+dZnKLXzr0oT2HFR6xFbofEIELrFFNDmAVqThxbp7D4T\n"\
"Tmvdc9vOl7M/6mft6zuU3Iey6KMluwuYrWt45ReQHgCOjdGSoaaZygx19WeHDlGY\n"\
"Kb55Up1V12OtrLCOIWTmmS5UTg==\n"\
"-----END CERTIFICATE-----"
...
void MqttRpcClientQt::init_mqtt_client_websocket(const QString &cookie) {
	...
	QSslConfiguration sslConfig = QSslConfiguration::defaultConfiguration();
	QList<QSslCertificate> certList;
	certList.append(QSslCertificate(QByteArrayLiteral(MQTT_AUTOGEN_CERT), QSsl::Pem));
	sslConfig.setCaCertificates(certList);

	const QString url = "wss://" + host.toString() + "/websocket-mqtt";
	const QString origin = "https://" + host.toString() + "gui-beta/";
...
void MqttRpcClientQt::connectClientSignals(){
	...
	int idrnd = arc4random() % 9000 + 1000;
